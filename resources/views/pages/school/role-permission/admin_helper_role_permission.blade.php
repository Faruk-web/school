...
@section('title')Admin Role Permission @endsection
@section('body_content')

<div class="row">
    <div class="col-md-7">
        <div class="rounded shadow">
            <form class="p-3" action="" method="post" id="form_1">
                @csrf
                    <div class="form-group">
                        ...
                        <div class="form-check mb-3">
                            <label class="form-check-label text-info fw-bold">{{ $group->group_name }}</label>
                        </div>
                        @php
    ...
    <div class="col-md-5">
        ...
        <h3>Provided Permissions</h3><hr>
            ...
            <div class="mb-3" id="provided_permission_group_{{$checked_group->group_name}}">
