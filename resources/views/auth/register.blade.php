...
<title>Eduorganizer Registration</title>
...
<div id="main-wrapper" class="oxyy-login-register">
  <div class="hero-wrap min-vh-100">
    ...
    <div class="hero-bg hero-bg-scroll" style="background-image:url({{asset('backend/register-assets/images/register-bg-9.jpg')}});"></div>
          ...
          <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
            <div class="hero-wrap rounded shadow-lg p-4 py-sm-5 px-sm-5 my-4">
              ...
              <div class="hero-content">
                ...
                <h6 class="text-center text-dark"><b>Welcome to <b class="text-danger">Eduorganizer</b> Registration!</b></h6><br>
                <form id="registerForm" class="form-dark" method="POST" action="{{ route('register') }}">
				  ...
				  <div class="mb-3 icon-group">
                    <input type="text" class="form-control text-dark" name="school_name" id="" required="" value="{{old('school_name')}}" placeholder="Institute Name">
                    <span class="icon-inside"><i class="fas fa-building"></i></span>
                    @if($errors->has('school_name'))
                        <div class="error text-danger">{{ $errors->first('school_name') }}</div>
                    @endif
				  </div>
