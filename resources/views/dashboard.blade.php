                                ...
                                <div class="block block-rounded block-themed mb-0">
                                    ...
                                    <div class="block-content text-center">
                                        <div class="p-sm-3 px-lg-4 py-lg-5">
                                            <a type="button" href="{{ route('/') }}" class="btn btn-primary">Dashboard</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- END Sign In Block -->
                                    ...
                                    <div class="block-content text-center">
                                        <div class="p-sm-3 px-lg-4 py-lg-5">
                                            ...
                                            <form method="POST" action="{{ route('logout') }}">
                                                @csrf
                                                    <a class="btn btn-success" href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">Log Out</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
