        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" style="padding: 30px;" action="{{route('branch.received.customer.due.confirm')}}" method="POST" id="form_1">
                                @csrf
...
<script>
    ...
    $('#customer_search').keyup(function () {
        ...
        $.ajax({
            type: 'get',
            url: '/branch/take-due/search-customer',
            data: {
