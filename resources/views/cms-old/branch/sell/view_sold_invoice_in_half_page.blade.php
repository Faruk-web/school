...
<body>
    <htmlpageheader  name="page-header">
        <div style="margin-left: 52%; padding-top: 5px;">
    ...
    <htmlpagefooter name="page-footer">
        ...
        <table style="margin-left: 52%; margin-bottom: 20px;" width="100%">
            ...
            <tr>
                ...
                <th style="text-align: right; border: 0px solid white;">
                    <p class="invoiceIDandDate" style="font-family: Arial;">Invoice #{{str_replace("_","/", $invoice_info->invoice_id)}}<br>Date:
                        {{date('d-m-Y', strtotime(optional($invoice_info)->date))}}<br>Voucher: <span style="color: #ffffff;">{{str_replace("_","/", $invoice_info->invoice_id)}}</span></p>
                </th>
            </tr>
        </table>
    </div>
    ...
    <div style="margin-top: 8px; text-align: right; margin-left: 52%;">
        <table>
