                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                  ...
                                  <li class="list-group-item">
                                    <div class="dropdown push">
                                        <button type="button" class="btn btn-primary btn-sm dropdown-toggle form-control bg-primary text-light" id="dropdown-content-rich-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Update Renew Date</button>
                                        <div class="dropdown-menu font-size-sm" aria-labelledby="dropdown-content-rich-primary" style="">
                                            <form class="p-2" action="{{route('super.admin.set.renew.date')}}" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for=""><span class="text-danger">*</span> Renew Date.</label>
                                                    <input type="date" class="form-control" name="renew_date" required="">
                                                    <input type="hidden" class="form-control" value="{{$shop_info->shop_code}}" name="shop_id" required="">
