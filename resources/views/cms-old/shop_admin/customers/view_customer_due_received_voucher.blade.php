                  ...
                  <div class="card-body">
                    <div class="row" id="homeBack">
                        <div class="col-md-12">
                            ...
                            <p class=""  style="font-size: 18px; font-family: Helvetica;"><b>Received With Thanks From Mr. / Mrs. </b>{{optional($voucher_info->customer_info)->name}}<br>
                               <span style="font-size: 15px;"><b>Address: </b>{{optional($voucher_info->customer_info)->address}}<b>, Phone:</b> {{optional($voucher_info->customer_info)->phone}}
                               <b>Payment By: @if($voucher_info->paymentBy == 'cash') Cash @elseif($voucher_info->paymentBy == 'cheque') {{$voucher_info->cheque_bank_or_mfs_name}} [{{$voucher_info->cheque_or_mfs_account}}] @endif
                               </span></p>
                                ...
                                <table class="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><b>Paid </b></td>
                                          <td>{{$currency}} {{number_format(optional($voucher_info)->received_amount, 2)}}</td>
                                        </tr>
                                        <tr>
                                          <td><b>Total Due </b></td>
                                          <td>{{$currency}} {{number_format(optional($voucher_info)->due-optional($voucher_info)->received_amount, 2)}}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    </div>
                  ...
                  <div class="card-footer">
                    <div class="row text-center">
                        ...
                        <div class="col-md-12 text-left">
                            <p><b>Received by: </b> {{optional($voucher_info->received_user_info)->name}}</p>
