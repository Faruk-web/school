...
<html lang="en">
  <head>
    ...
    <title>{{$customer_info->name}} Sold Products Ledger</title>
    <style>
        tr th, td{
            font-size: 15px;
        }
          ...
          <div class="container-fluid">
              <div class="row">
                  ...
                  <table class="table table-bordered" style="margin-top: 20px; margin-bottom: 20px;">
                    <thead>
                        <tr class="text-center"><th colspan="13"><h3>Customer Sold Products Ledger</h3><span><b>Name: </b>{{optional($customer_info)->name}} / <b>Phone: </b>{{optional($customer_info)->phone}} / <b>Address: </b>{{optional($customer_info)->address}}</span></th></tr>
                        <tr>
                            <th scope="col">SN.</th>
                    ...
                    <tbody>
                        @foreach($orders as $key => $order)
                            ...
                            <?php
                                $return_product = DB::table('product_trackers')->where(['invoice_id'=>$product->invoice_id, 'product_id'=>$product->product_id, 'product_form'=>'R'])->get(['total_price', 'quantity']);
