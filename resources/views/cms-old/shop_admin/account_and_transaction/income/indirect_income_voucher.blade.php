                ...
                <div class="card" style="border: 2px solid black">
                  <div class="card-header text-center">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <h6><b class="text-capitalize">{{optional($voucher_info->head_name->group_name)->group_name}} Voucher</b></h6>
                               <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                  <label class="btn btn-success active">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Cradit
                                  </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button type="button" class="btn btn-success text-light text-uppercase">{{$voucher_info->cash_or_cheque}}</button>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div style="padding: 0px 30px;">
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                        <td width="80%"><p><b>Pay to / for: </b> {{$voucher_info->head_name->head_name}} [{{optional($voucher_info->head_name->group_name)->group_name}}] @if(!empty($voucher_info->voucher))<br><b>Physical Voucher: </b> {{$voucher_info->voucher}} @endif @if(!empty($voucher_info->file))<br><a target="_blank" class="text-danger" href="{{asset('images/'.$voucher_info->file)}}">Attached file</a> @endif</p></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                        <td><b>Received By:</b> @if($voucher_info->cash_or_cheque == 'cash') Cash @elseif($voucher_info->cash_or_cheque == 'cheque') Cheque [ {{optional($voucher_info->bank_info)->bank_name."( ".optional($voucher_info->bank_info)->account_no." )"}} ] @endif</td>
