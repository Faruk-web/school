...
<div class="content">
    <div class="block block-rounded">
        <div class="row p-2">
            <div class="col-md-8"><h4 class="">Trial Balance</h4></div>
                ...
                <div class="dropdown push">
                    ...
                    <div class="dropdown-menu font-size-sm" aria-labelledby="dropdown-content-rich-primary">
                        <form class="p-2" action="javascript:void(0)" method="">
                            ...
                            <button type="button" onclick="date_range_trial_balance()" class="btn btn-success btn-sm">Save</button>
                        </form>
                    </div>
                </div>
            </div> -->
        ...
        <div class="block-content">
            <div class="pb-30">
                <h6><b>Date: </b> {{date('d M, Y h:i a')}}</h6>
                <div class="" id="trial_balance_body">
                    <div class="row">
...
<script type="text/javascript">
    ...
    // function date_range_trial_balance() {
    ...
    //         trial_balance(date_range_start_date, date_range_end_date);
    //         $('#single_day_date').val('');
    //     }
    //     else {
    //         Toastify({
    ...
    function trial_balance(first_date, last_date) {
        $.ajax({
            type: 'get',
            url: '/admin/report/trial-balance-data',
            data: {
                'first_date': first_date,
                'last_date': last_date,
            },
            beforeSend: function() {
                $('#trial_balance_body').html('<div class="text-center"><div class="spinner-border text-dark mb-5" role="status"><span class="sr-only">Loading...</span></div></div>');
            },
            success: function (data) {
                $('#trial_balance_body').html(data);
            }
        });
    }
