...
<div class="content">
    <div class="block block-rounded">
        <div class="block-header">
            <h4 class="">Business Owners / Capital Persons</h4>
                ...
                <table width="100%" class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{number_format($person->capital, 2) }}</em></td>
                            ...
                            <td class="text-center" width="15%">
                                ...
                                <a type="button" target="_blank" href="{{route('report.owner.ledger.table', ['id'=>$person->id])}}" class="btn btn-rounded btn-sm btn-success">Ledger</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<div class="modal fade" id="modal-block-fadein" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('admin.create.new.capital.person')}}" method="post" id="form_1">
                        @csrf
