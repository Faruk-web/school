...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header">
            <h4 class="">Admin Helper Roles</h4>
                ...
                <table width="100%" class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                <a type="button" href="{{url('/admin/edit-admin-role/'.$role->id)}}" class="btn btn-sm btn-info" data-toggle="tooltip" title="Edit"><i class="fa fa-fw fa-pencil-alt"></i></a>
                                <a type="button" href="{{url('/admin/admin-helper-role-permissions/'.$role->id)}}" class="btn btn-sm btn-alt-primary" data-toggle="tooltip" title="Permissions">Permissions</a>
                            </td>
                        </tr>
                        @php( $i += 1 )
                        @endforeach
...
<div class="modal fade" id="modal-block-fadein" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('admin.create.roll')}}" method="post" id="form_1">
                        @csrf
