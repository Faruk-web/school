            ...
            <div class="block block-rounded d-flex flex-column">
                <div
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12 p-2 mb-4" id="variation_info_div" style="display: none;">
                            <div class="row shadow rounded">
                                <div class="col-md-3 p-2">
                                    ...
                                    <div class="row ml-3">
                                        ...
                                        @if($list->is_active == 1)
                                        <div class="col-md-12">
                                            <button type="button" id="list_id{{$list->id}}" onclick="checkVariation('{{$list->list_title}}', '{{$list->id}}')"  class="variation_button btn btn-primary btn-sm btn-block mb-2 btn-rounded" >{{$list->list_title}}</button>
                                        </div>
                                        @endif
                                        @endforeach
                                    </div>
