                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="number" required step=any value="{{optional($printer)->page_width}}" class="form-control form-control-sm" name="page_width" id="page_width">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Page Margin Left(inch)</b></small>
                                                        <input type="number" value="{{optional($printer)->page_margin_left}}" step=any class="form-control form-control-sm" name="page_margin_left" id="page_margin_left">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Page Margin Right(inch)</b></small>
                                                        <input type="number" value="{{optional($printer)->page_margin_right}}" step=any class="form-control form-control-sm" name="page_margin_right" id="page_margin_right">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Page Margin Top(inch)</b></small>
                                                        <input type="number" value="{{optional($printer)->page_margin_top}}" step=any class="form-control form-control-sm" name="page_margin_top" id="page_margin_top">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Page Margin Bottom(inch)</b></small>
                                                        <input type="number" value="{{optional($printer)->page_margin_bottom}}" step=any class="form-control form-control-sm" name="page_margin_bottom" id="page_margin_bottom">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm" name="barcode_in_per_row" id="barcode_in_per_row" required>
                                                    ...
                                                    <option @if(optional($printer)->barcode_row == 1) selected class="bg-success" @endif value="1">1</option>
                                                    <option @if(optional($printer)->barcode_row == 2) selected class="bg-success" @endif value="2">2</option>
                                                    <option @if(optional($printer)->barcode_row == 3) selected class="bg-success" @endif value="3">3</option>
                                                    <option @if(optional($printer)->barcode_row == 4) selected class="bg-success" @endif value="4">4</option>
                                                    <option @if(optional($printer)->barcode_row == 5) selected class="bg-success" @endif value="5">5</option>
                                                </select>
                                            </div>
                                            <div class="row rounded shadow mt-1 border">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step=any value="{{optional($printer)->barcode_width}}" required class="form-control form-control-sm" name="barcode_width" id="barcode_width">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b><span class="text-danger">*</span>Barcode Column Height(inch)</b></small>
                                                        <input type="number" step=any value="{{optional($printer)->barcode_height}}" required class="form-control form-control-sm" name="barcode_height" id="barcode_height">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row rounded shadow mt-3 border">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step=any value="{{optional($printer)->barcode_margin_left}}" class="form-control form-control-sm" name="barcode_column_margin_left" id="barcode_column_margin_left">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Barcode Column Margin Right(pixel)</b></small>
                                                        <input type="number" step=any value="{{optional($printer)->barcode_margin_righ}}t" class="form-control form-control-sm" name="barcode_column_margin_right" id="barcode_column_margin_right">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Barcode Column Margin Top(pixel)</b></small>
                                                        <input type="number" step=any value="{{optional($printer)->barcode_margin_top}}" class="form-control form-control-sm" name="barcode_column_margin_top" id="barcode_column_margin_top">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <small><b>Barcode Column Margin Bottom(pixel)</b></small>
                                                        <input type="number" step=any value="{{optional($printer)->barcode_margin_bottom}}" class="form-control form-control-sm" name="barcode_column_margin_bottom" id="barcode_column_margin_bottom">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-2" id="additional_column_info">
                                                @if(optional($printer)->barcode_row > 0)
                                                    @php($i = 1)
                                                    @for($i; $i <= optional($printer)->barcode_row; $i++)
                                                        <div class="row rounded shadow mt-3 border">
                                                            <div class="col-md-12">
                                                                <h5 class="text-success"><b>Column {{$i}} Additional Style(Optional):</b></h5>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group"><small><b>Column {{$i}} Margin Left(pixel)</b></small><input type="number"
                                                                        onkeyup="customControl()" step="any" value="@if($i == 1){{optional($printer)->column1_margin_left}}@elseif($i == 2){{optional($printer)->column2_margin_left}}@elseif($i == 3){{optional($printer)->column3_margin_left}}@elseif($i == 4){{optional($printer)->column4_margin_left}}@elseif($i == 5){{optional($printer)->column5_margin_left}}@endif"
                                                                        class="form-control form-control-sm" name="margin_left_for_column{{$i}}" id="margin_left_for_column{{$i}}"></div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group"><small><b>Column {{$i}} Margin Right(pixel)</b></small><input type="number"
                                                                        onkeyup="customControl()" step="any" value="@if($i == 1){{optional($printer)->column1_margin_right}}@elseif($i == 2){{optional($printer)->column2_margin_right}}@elseif($i == 3){{optional($printer)->column3_margin_right}}@elseif($i == 4){{optional($printer)->column4_margin_right}}@elseif($i == 5){{optional($printer)->column5_margin_right}}@endif"
                                                                        class="form-control form-control-sm" name="margin_right_for_column{{$i}}" id="margin_right_for_column{{$i}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group"><small><b>Column {{$i}} Margin Top(pixel)</b></small><input type="number"
                                                                        onkeyup="customControl()" step="any" value="@if($i == 1){{optional($printer)->column1_margin_top}}@elseif($i == 2){{optional($printer)->column2_margin_top}}@elseif($i == 3){{optional($printer)->column3_margin_top}}@elseif($i == 4){{optional($printer)->column4_margin_top}}@elseif($i == 5){{optional($printer)->column5_margin_top}}@endif"
                                                                        class="form-control form-control-sm" name="margin_top_for_column{{$i}}" id="margin_top_for_column{{$i}}"></div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group"><small><b>Column {{$i}} Margin Bottom(pixel)</b></small><input type="number"
                                                                        onkeyup="customControl()" step="any" value="@if($i == 1){{optional($printer)->column2_margin_bottom}}@elseif($i == 2){{optional($printer)->column2_margin_bottom}}@elseif($i == 3){{optional($printer)->column3_margin_bottom}}@elseif($i == 4){{optional($printer)->column4_margin_bottom}}@elseif($i == 5){{optional($printer)->column5_margin_bottom}}@endif"
                                                                        class="form-control form-control-sm" name="margin_bottom_for_column{{$i}}" id="margin_bottom_for_column{{$i}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endfor
                                        ...
                                        <div class="row rounded shadow mt-1 border">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step=any required class="form-control form-control-sm" value="{{optional($printer)->barcode_image_height}}" name="image_height" id="image_height">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <small><b><span class="text-danger">*</span>Text Size(px)</b></small>
                                                    <input type="number" step=any required class="form-control form-control-sm" value="{{optional($printer)->text_size}}" name="text_size" id="text_size">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row  mt-1 mb-5">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="" name="branch_id">
                                                      <option @if(optional($printer)->branch_id == 'all') selected @endif value="all">All</option>
                                                      @foreach($branches as $branch)
                                                      <option @if(optional($printer)->branch_id == $branch->id) selected @endif value="{{$branch->id}}">{{$branch->branch_name}} [{{$branch->branch_address}}]</option>
                                                      @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" step=any  class="form-control form-control-sm" name="printer_name" value="{{optional($printer)->printer_name}}" id="printer_name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step=any  class="form-control form-control-sm" value="{{optional($printer)->code}}" name="code" id="code">
                                                </div>
                                                <div class="form-group">
                                                    <small><b>Note ( Optional )</b></small>
                                                    <textarea class="form-control" name="note" id="note" rows="2">{{optional($printer)->note}}</textarea>
                                                </div>
